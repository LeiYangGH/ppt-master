...
Usage:
    ...
    python scripts/svg_finalize/fix_image_aspect.py workspace/svg_output/*.svg

    # Preview mode
    python scripts/svg_finalize/fix_image_aspect.py --dry-run workspace/svg_output/*.svg

Examples:
    python scripts/svg_finalize/fix_image_aspect.py workspace/svg_output/slide_06_current_overview.svg
"""
...
Examples:
  ...
  %(prog)s workspace/svg_output/*.svg      # Process workspace directory
        '''
    )
